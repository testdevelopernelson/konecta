        ...
        _controls: {
            ...
            select: {
                create: function (tp_inst, obj, unit, val, min, max, step) {
                    ...
                    sel += '<option value="" selected></option>'; // linea ingresada para tener opcion vacia y poder hacer control de validacion de datos
                    for (var i = min; i <= max; i += step) {
                        
                        // sel += '<option value="' + i + '"' + (i === val ? ' selected' : '') + '>'; // Se desactiva esta linea, y se agrega la siguiente, para que el select no tenga una hora por defecto
                        sel += '<option value="' + i + '">';
                        if (unit === 'hour') {
